...
public class PatchTest {
    ...
    void patchUserTest() throws Exception {
        // Given
        String requestBody = getRequestBody(1L,"newNickName","010-1234-5679");
        ...
        result.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.data.phoneNumber").value("010-1234-5679"));
    }
...
//        UserDto.Patch patch = getPatch(4L, "name", "", "010-5678-1234", "FEMALE");
//        String requestBody = objectMapper.writeValueAsString(patch);
//
//        // When
//        ResultActions result = getResultAction(requestBody);
...
//    }
    private String getRequestBody(Long id, String nickName,String phoneNumber ) throws JsonProcessingException {

        UserDto.Patch patch = getPatch(id, nickName,phoneNumber);
        String requestBody = objectMapper.writeValueAsString(patch);
        return requestBody;
    }
    ...
    private static UserDto.Patch getPatch(Long id, String nickName, String phoneNumber ) {

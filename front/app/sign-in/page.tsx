...
export default function Search() {
    ...
    <div>
        ...
        <div style={{ position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <img src="/signInPaper.png" alt="image" style={{ width: '80vw', maxWidth: '1500px', height: '80vh', maxHeight: '2000px', marginTop: '10px'}} />
            <div style={{ position: 'absolute', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'space-between', minHeight: '20vw' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center',maxHeight:'50vh' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                        <div>
                            {labels.map((label, index) => (
                                <div key={index}>
                                    <h2 className={"signInText"}>{label}:</h2>
                                </div>
                            ))}
                        </div>
                        <div>
                    ...
                    <h1 style={{ fontSize: '2vw', fontFamily: 'Pacifico, cursive', marginTop: '5vw',color: 'red' }}>{errorMessage}</h1>
                </div>

                <div>
                    <h1 style={{ fontSize: '2vw', fontFamily: 'Pacifico, cursive', marginTop: '5vw',color:color }}
